...
# Whisper Local Model
MODEL_DIR = "assets/models_stt"
WHISPER_VERSION = "large"     # tiny, base, small, medium, large, large-v2
WHISPER_COMPUTE_TYPE = "float32" # float16 | float32 | int8
WHISPER_LANGUAGE = "vi"          # None = auto detect
...
class ASRPipeline:
    ...
    def __call__(self, audio: np.ndarray) -> Dict:
        ...
        chunks = chunk_audio(audio, SAMPLE_RATE, segments)
        results = []        
        time_str = time.time()  
